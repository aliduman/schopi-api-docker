...
class File{
	...
	private $DEFAULT_location  = "/public/images/";
    ...
    public function getFileName(){
        return $this->files[0]['actual_name'];
    }

    public function getFilePath(){
        return $this->DEFAULT_location . $this->files[0]['actual_name'];
    }

    public function delete($file)
    {
        if( file_exists($this->DEFAULT_location . $file) ){
            unlink($this->DEFAULT_location . $file);
            return true;
        }else{
